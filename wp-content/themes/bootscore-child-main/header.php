        ...
        <nav id="nav-main" class="navbar navbar-expand-lg">
          ...
          <div class="container d-block">
            ...
            <div class="row">
              <div class="col-sm-2">
                <!-- Navbar Brand -->
                <a class="navbar-brand xs d-md-none" href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/
            " alt="logo" width="70px" class="logo xs"></a>
                <a class="navbar-brand md d-none d-md-block" href="<?php echo esc_url(home_url()); ?>"><img
                    src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/icm-logo.png" alt="logo"
